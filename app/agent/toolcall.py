...
class ToolCallAgent(ReActAgent):
    ...
    async def think(self) -> Tuple[bool, str, str, TokenUsage]:
        ...
        try:
            ...
            response, token_usage = await self.llm.ask_tool(
            ...
            if hasattr(e, "__cause__") and isinstance(e.__cause__, TokenLimitExceeded):
                ...
                thought = f"最大token限制，无法继续执行：{str(token_limit_error)}"
                self.state = AgentState.FINISHED
                return False, thought, action, token_usage
            raise
        ...
        try:
            ...
            if self.tool_choices == ToolChoice.NONE:
                ...
                if content:
                    ...
                    return True, thought, action, token_usage
                return False, thought, action, token_usage
            ...
            if self.tool_choices == ToolChoice.REQUIRED and not self.tool_calls:
                return True, thought, action, token_usage  # Will be handled in act()
            ...
            if self.tool_calls:
                ...
                action = "没有工具调用"
            return bool(self.tool_calls), thought, action, token_usage
        except Exception as e:
